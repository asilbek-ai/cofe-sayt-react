...
function Orders() {
  ...
  const confirmOrder = () => {
    ...
    // 🔥 FULL PRODUCT DATA QO‘SHAMIZ
    const fullOrders = basket.map((item) => {
      const product = getProduct(item.cofeId);
        ...
        <div className="w-1/2">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 mt-2">
                        ...
                        <button
                          ...
                          className="bg-red-600 px-4 rounded-lg text-white font-bold"
                        >
                          Delete
                        </button>
          ...
          <div className="bg-[#F3F2F2] rounded-2xl mt-10 p-6">
            ...
            <div className="flex justify-between">
              ...
              <span>{entrega} ming</span>
            </div>

            <div className="flex justify-between font-bold text-lg">
              <span>Total</span>
              <span>{total} ming</span>
            </div>
